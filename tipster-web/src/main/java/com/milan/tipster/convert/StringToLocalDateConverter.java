...
import static com.milan.tipster.util.DateUtils.LOCAL_DATE_PATTERN_DEFAULT;

/**
 * Spring type converter, needed for converting dates in queryDsl search parameters.
 * Can be used globally
 */
@Component
public class StringToLocalDateConverter implements Converter<String, LocalDate> {

    private static final List<String> SUPPORTED_FORMATS = Arrays.asList(LOCAL_DATE_PATTERN_DEFAULT, "dd-MM-yyyy", "yyyy-MM-dd");
